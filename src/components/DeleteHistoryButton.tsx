...
export default function DeleteHistoryButton({result, setcomicIdToDelete} : {result: any, setcomicIdToDelete: any}) {
    ...
    return (
    <Button className="" variant="ghost" onClick={() => handleClick(result.id, result.userID)}>
          <TiDelete />
    </Button>
  )
}
