            ...
            <div className="gap-10 flex pb-8">
                ...
                <div className='text-left text-lg'>
                    ...
                    <ul className='leading-10'>
                        ...
                        <li> <AiFillLike className='inline'/> Lượt thích: {(comic.isCompleted ? "Hoàn thành" : "Chưa hoàn thành")}</li>
                        <li> <FaHeart className='inline'/> Lượt theo dõi: {(comic.isCompleted ? "Hoàn thành" : "Chưa hoàn thành")}</li>
                        <li> <FaRegEye className='inline'/> Lượt xem: {(comic.isCompleted ? "Hoàn thành" : "Chưa hoàn thành")}</li>                        
                    </ul>
                    <div className='flex gap-5 mt-6'>
                        <Link href={"/comic/" + comic.id + "/" +comic.comicChapters[0].chapterNumber}><Button className='font-bold' color='warning' >Đọc từ đầu</Button> </Link>
                        <ComicPageButton />
                    </div>
